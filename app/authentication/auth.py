...
class Authentication:
    ...
    def doctor_registration(cls):
        try:
            ...
            db.insert_table("users",["user_name","user_pass","user_email","user_mobile"], [ user_name, user_pass_1, user_email, user_mobile])
            user_id = input("Please Enter your id : ")
            db.insert_table("doctors", ["doctor_name", "expertis", "work_experience", "adress", "visit_price", "users_user_id"],
    ...
    def patient_registeration(cls):
        try:
            ...
            patient_address = input("Enter your addrress : ")
            patient_obj = models.Paient(user_name, user_pass_1, user_email, user_mobile, patient_name, patient_address)
            db.insert_table("users",["user_name","user_pass","user_email","user_mobile"], [ user_name, user_pass_1, user_email, user_mobile])
            user_id = input("Please Enter your id : ")
            db.insert_table("patients", ["patient_name", "patient_adress", "users_user_id"],
    ...
    def login(cls):
        ...
        if db.select(["users"],select_options=["user_id"],filter_options=[("users.user_name","=", f"'{user_name}'"),("users.user_pass", "=",f"'{input_password}'")]):
            return True
        else:
            return False
    ...
    #     user_name = input("Enter your username : ")
    #     input_password = input("Enter your password : ")
    #     if db.select("users",select_options="user_id",filter_options=[("users.user_name","=", user_name)("users.user_pass", "=",input_password)]):
    #         return True
    #     else:
    #         return False
